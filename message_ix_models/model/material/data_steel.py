...
from message_ix_models.model.material.material_demand.math import weibull_scrap_release
...
def gen_data_steel(scenario: message_ix.Scenario, dry_run: bool = False):
    ...
    scrap_avail = get_weibull_scrap_release(df_fin_use_r12, recovery_factor=0.95)
